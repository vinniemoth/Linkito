      ...
      <section className="flex justify-center items-center flex-col gap-10 bg-cinza-200 h-screen">
        ...
        <div className="flex justify-center items-center gap-5">
          <div className="flex flex-col justify-center border-grey-300 border-solid border-1 p-10">
            ...
            <h2 className="text- font-bold">$0 / month</h2>
            <div className="flex items-center gap-2">
              <FaCheck className="text-"></FaCheck>
            ...
            <button className="mt-10 bg- hover:bg-roxo text-2xl p-3 rounded-lg transition duration-200 cursor-pointer">
              Start Now
            </button>
          </div>
          <div className="flex flex-col justify-center border-grey-300 border-solid border-1 p-10">
            ...
            <button className="mt-10 bg-roxo hover:bg- text-2xl p-3 rounded-lg transition duration-200 cursor-pointer">
              Upgrade Now
            </button>
          </div>
        </div>
